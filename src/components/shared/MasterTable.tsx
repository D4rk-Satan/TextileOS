...
import { Phone, MapPin, Tag, Hash, Trash2, Search, Loader2, Edit } from 'lucide-react';
        ...
        <table className="w-full text-left border-separate border-spacing-0">
          <thead>
            <tr className="border-b border-border bg-muted/20">
              <th className="px-8 py-4 text-[10px] font-bold text-muted-foreground uppercase tracking-wider w-20 text-center first:rounded-tl-2xl">ID</th>
              ...
              {!isReadOnly && <th className="px-8 py-4 text-[10px] font-bold text-muted-foreground uppercase tracking-wider w-24 text-right last:rounded-tr-2xl">Actions</th>}
            </tr>
          </thead>
              ...
              {data.map((item) => {
                ...
                return (
                  <motion.tr 
                    ...
                    className={cn(
                      "group hover:bg-muted/30 transition-all cursor-default relative",
