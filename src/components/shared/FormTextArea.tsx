...
export function FormTextArea({ name, label, required, icon: Icon, rules, className, variant = 'light', ...props }: TextAreaProps) {
  const {
    register,
    formState: { errors },
  } = useFormContext();
    ...
    >
      ...
      <div className="relative group">
        ...
        <textarea
          ...
          id={name}
          className={cn(
            'flex min-h-[100px] w-full rounded-lg border border-border py-2.5 text-sm transition-all resize-none',
