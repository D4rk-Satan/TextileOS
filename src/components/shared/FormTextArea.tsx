  ...
  return (
    ...
    >
      ...
      <div className="relative group">
        {Icon && (
          <div className="absolute left-4 top-4 text-muted-foreground group-focus-within:text-blue-600 transition-colors pointer-events-none">
            <Icon size={18} />
          </div>
        )}
        <textarea
          ...
          id={name}
          className={cn(
            'flex min-h-[120px] w-full rounded-xl border border-border bg-white/50 dark:bg-black/20 py-3 text-sm transition-all resize-none',
